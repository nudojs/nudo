...
| 计划 | 状态 |
|------|------|
| [`2026-09-19-close-remaining-dx-gaps.md`](./superpowers/plans/2026-09-19-close-remaining-dx-gaps.md) | **现行**：IDE/LSP 收口 + Node/`@types` 生态覆盖（无固定周期，只排依赖） |
| [`2026-05-28-close-ts-dx-gaps.md`](./superpowers/plans/2026-05-28-close-ts-dx-gaps.md) | 主体已交付；剩余项见上表新计划 |
| 其余 `superpowers/plans/` 与 `superpowers/specs/` | 历史——其中对
