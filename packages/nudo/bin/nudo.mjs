#!/usr/bin/env node
// Thin shell for the `nudo` command. This package reserves the "nudo" name
// on npm and hands execution to @nudojs/cli, whose package entry (`exports`
// "." → dist/index.js) is the same module as its `nudo` bin.
//
