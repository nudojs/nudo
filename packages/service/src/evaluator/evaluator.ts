...
import { createMapType, mapEntriesIterable, exactMapEntries } from "./builtins/builtin-map.ts";
import { createSetType, setValuesIterable, exactSetValues } from "./builtins/builtin-set.ts";
import { createRegExpType } from "./builtins/builtin-regexp.ts";
import { createURLType, createURLSearchParamsType } from "./builtins/builtin-url.ts";
import {
  createResponseType,
  createHeadersType,
  createFormDataType,
...
import { createWeakMapType, createWeakSetType } from "./builtins/builtin-weak.ts";
import { SYMBOL_STATIC_PROPS } from "./builtins/builtin-symbol.ts";
import { createDateTimeFormatType, createNumberFormatType } from "./builtins/builtin-intl.ts";
import {
...
import { BUILTIN_STATIC_METHODS, builtinInstanceTest, jsonToTypeValue } from "./builtins/builtin-static.ts";
import { evaluateBuiltinCall, evaluateMethodCall } from "./builtins/builtin-methods.ts";
...
export function arrayIsArrayLiteral(v: TypeValue): boolean | undefined {
...
export const RETURN_SIGNAL = Symbol("ReturnSignal");
export const BRANCH_SIGNAL = Symbol("BranchSignal");
export const THROW_SIGNAL = Symbol("ThrowSignal");
...
export function makeThrow(thrown: TypeValue, loc?: SourceRange): ThrowSignal {
  return { [THROW_SIGNAL]: true, thrown, loc };
}

export function isReturn(v: unknown): v is ReturnSignal {
  return typeof v === "object" && v !== null && RETURN_SIGNAL in v;
}

export function isBranch(v: unknown): v is BranchSignal {
  return typeof v === "object" && v !== null && BRANCH_SIGNAL in v;
}

export function isThrow(v: unknown): v is ThrowSignal {
...
export type EvalResult = TypeValue | ReturnSignal | BranchSignal | ThrowSignal;
...
export function copyOrigin(from: TypeValue, to: TypeValue): void {
...
export function recordUnknown(r: Omit<UnknownRecord, "loc"> & { loc?: Node["loc"] }): void {
...
export function distributeOverUnion(
  tv: TypeValue,
...
export function evaluateArgs(args: Node[], env: Environment): TypeValue[] | ReturnSignal | BranchSignal | ThrowSignal {
...
export function applyPromiseThenCallback(
